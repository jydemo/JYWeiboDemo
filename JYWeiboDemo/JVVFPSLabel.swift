...
class JVVFPSLabel: UILabel {
    ...
    override init(frame: CGRect) {
        ...
        if jFrame.origin.x == 0 && jFrame.origin.y == 0 {
            
            jFrame = CGRect(x: UIScreen.main.bounds.width / 2 - (55 / 2), y: 15, width: 55, height: 20)
        
        }
        
        super.init(frame: jFrame)
